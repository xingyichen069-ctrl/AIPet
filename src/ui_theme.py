...
ROLES = {
    ...
    'satori': (
        ...
        #                      button ↓ 夜间按钮是亮粉红 #d25b67，上面压深字。
        #   button_text 原本 #2b1520，算下来 4.41:1，差一点过不了 4.5。
        #   按钮本身不能再调深 —— 深字压深按钮只会更低（#ce5662 降到 4.17）。
        #   所以压的是字：#25101a，4.65:1。
        ('#f4e5e5', '#c1a4aa', '#5e3e4b', '#51313e', '#ffd8d8', '#ef7b83', '#271c2b', '#d25b67', '#25101a', '#2b202e', '#4b2935')),
    'flandre': (
