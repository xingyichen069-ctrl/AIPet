...
class SettingsDialog(QDialog):
    ...
    def _api_page(self):
        ...
        self.api_key_edit.setPlaceholderText("留空则删除本地 key，或使用 DEEPSEEK_API_KEY")
        key_row = QHBoxLayout()
    ...
    def reload_all(self):
        ...
        self.api_key_edit.setText(str(secrets.get("deepseek_api_key", "")))
        self.base_url_edit.setText(str(secrets.get("deepseek_base_url", "https://api.deepseek.com")))
    ...
    def _load_preset_editor(self):
        ...
        params = ((self._thinking_cfg.get("presets", {}).get(key) or {}).get("params") or {}
                  if key else {})
        self.model_edit.setText(str(params.get("model", "deepseek::deepseek-flash")))
